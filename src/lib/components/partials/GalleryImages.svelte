<script>
  ...
  // refcatored reactive statement ($:) to $effect rune
  $effect(() => {
    ...
    <div class="column is-one-third">
      <div class="card">
        <div class="card-content">
          ...
          <!-- changed 'on:click' & 'on:keydown' to 'onclick' & 'onkeydown' attribute (move towards HTML Attributes) -->
          <button 
            class="image-button"
            onclick={() => handleCarSelect(car)}
            onkeydown={(e) => e.key === 'Enter' && handleCarSelect(car)}
          >
